'''
Week 6 Team Activity Amusement Park
Asks the user for the age height height of the riders and determines if the
riders can ride
Oct 22 2020
'''
...
if rider_num == 1:
    solo_rider_height = int(
        input("What is the height of the rider in inches?"))
    ...
    if many_riders_age <= 18:
        if many_riders_age <= 17 and many_riders_age >= 12:
            golden_passport = input(
                "Do any riders have a golden passport? (y/n)")
            if golden_passport == "y":
                many_riders_height = int(
                    input("What is the height of the shortest rider in inches?"))
                ...
                youngest_rider = int(
                    input("What is the age of the youngest rider?"))
